...
define('FORGEDSEO_CORE_VERSION', '0.1.9');
...
require_once FORGEDSEO_CORE_DIR . 'includes/chrome.php';
require_once FORGEDSEO_CORE_DIR . 'includes/page-h1.php';
require_once FORGEDSEO_CORE_DIR . 'includes/blog-empty.php';
